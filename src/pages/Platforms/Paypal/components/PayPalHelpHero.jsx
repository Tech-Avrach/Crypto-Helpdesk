...
export default function PayPalHelpHero() {
          ...
          <h1 className="text-gray-800 mb-4">
            ...
            <div className="text-4xl md:text-6xl font-medium mb-6">
              ...
              <span 
                ...
                style={{ backgroundColor: 'white', color: paypalBlue }}
              >
                PayPal
              </span>
            </div>
          ...
          <div className="relative max-w-2xl mx-auto">
            <div className="relative">
              ...
              <motion.div
                ...
                style={{
                  background: `linear-gradient(to right, rgba(251, 191, 36, 0.2), rgba(0, 112, 223, 0.2), rgba(236, 72, 153, 0.2))`
                }}
                animate={{
                  scale: [1, 1.02, 1],
                  opacity: [0.5, 0.8, 0.5]
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background: `linear-gradient(to right, #fbbf24, ${paypalBlue}, #ec4899)`
              }}
              animate={{
                x: ['-100%', '100%'],
              }}
