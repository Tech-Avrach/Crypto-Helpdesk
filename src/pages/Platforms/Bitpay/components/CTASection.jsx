        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-[#293b92]/30 via-transparent to-gray-50/30 rounded-3xl"></div>
              ...
              <div className="relative z-10">
                ...
                <motion.button
                  variants={itemVariants}
                  className="group relative inline-flex items-center gap-3 bg-[#293b92] hover:bg-[#293b92] text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-[#293b92]/50"
                  whileHover={{ 
                    scale: 1.02,
                    y: -2
                  }}
              ...
              {/* Decorative elements */}
              <motion.div
                className="absolute top-6 right-6 w-2 h-2 bg-[#293b92]/20 rounded-full"
                animate={{
                  scale: [1, 1.5, 1],
                  opacity: [0.2, 0.6, 0.2]
                }}
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ 
                    y: -4,
                    scale: 1.02,
                    boxShadow: 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.06), 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -2px rgba(0, 0, 0, 0.05)',
                ...
                >
                  ...
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-b from-gray-50/50 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    initial={false}
                  />
                  ...
                  <div className="relative z-10 text-center">
                    {/* Icon */}
                    <motion.div
                      className="inline-flex items-center justify-center w-12 h-12 bg-[#293b92] text-white rounded-xl mb-4 group-hover:bg-[#293b92] transition-colors duration-300"
                      whileHover={{ 
                        rotate: [0, -5, 5, 0],
                        scale: 1.1 
                      }}
                    ...
                    <span className="text-[#293b92] font-medium text-sm group-hover:text-[#293b92] transition-colors duration-300">
                      {method.action}
                    </span>
                  </div>
                </motion.div>
