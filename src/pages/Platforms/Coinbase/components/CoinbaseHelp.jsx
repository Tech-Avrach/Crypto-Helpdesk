...
export default function CoinbaseHelpHero() {
      ...
      <div className="w-full max-w-4xl text-center">
        ...
        >
          <h1 className="text-gray-800 mb-4">
            ...
            <div className="text-4xl md:text-6xl font-medium mb-6">
              Having Issue in{' '}
              <span className="font-black text-blue-600 bg-white px-4 py-2 rounded-lg inline-block transform hover:scale-105 transition-transform duration-200">
                Coinbase
              </span>
            </div>
        ...
        >
          <div className="relative max-w-2xl mx-auto">
            <div className="relative">
              ...
              />
              <motion.div
                className="absolute inset-0 rounded-full bg-gradient-to-r from-yellow-400/20 via-blue-500/20 to-pink-500/20 -z-10"
                animate={{
                  scale: [1, 1.02, 1],
                  opacity: [0.5, 0.8, 0.5]
                }}
        ...
        >
          ...
          >
            ...
            <motion.div
              className="absolute inset-0 bg-gradient-to-r from-yellow-400 via-blue-500 to-pink-500 opacity-0 group-hover:opacity-20 transition-opacity duration-300"
              animate={{
                x: ['-100%', '100%'],
              }}
              transition={{
