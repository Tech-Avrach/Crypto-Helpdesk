...
export default function TopCoinbaseIssues() {
  ...
  const rightColumnIssues = [
    ...
    { title: "Coinbase pricing and fees disclosures", hasArrow: true },
    { title: "Coinbase Earn", hasArrow: false, isCategory: true },
  ...
  const IssueItem = ({ issue, index }) => (
    ...
    >
      ...
      {!issue.isCategory && (
        <motion.div
          className="absolute inset-0 bg-gradient-to-r from-blue-600/5 via-transparent to-blue-600/5 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"
          initial={false}
        />
      )}
    </motion.div>
