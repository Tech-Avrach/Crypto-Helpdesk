          ...
          >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <motion.button
                  variants={itemVariants}
                  className="group relative inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-blue-200/50"
                  whileHover={{ 
                    scale: 1.02,
                    y: -2
                  }}
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 text-center">
                    {/* Icon */}
                    <motion.div
                      className="inline-flex items-center justify-center w-12 h-12 bg-blue-600 text-white rounded-xl mb-4 group-hover:bg-blue-700 transition-colors duration-300"
                      whileHover={{ 
                        rotate: [0, -5, 5, 0],
                        scale: 1.1 
                      }}
