...
export default function CTASectionCashApp() {
  const cashAppGreen = '#00e011';
          ...
          <motion.div variants={itemVariants} className="mb-16">
            ...
            >
              ...
              <div
                ...
                style={{ background: `linear-gradient(135deg, ${cashAppGreen}20, transparent)` }}
              ></div>
              ...
              <div className="relative z-10">
                ...
                <motion.button
                  ...
                  style={{
                    ...
                    boxShadow: `0 4px 14px ${cashAppGreen}50`
                  }}
              ...
              <motion.div
                ...
                style={{ backgroundColor: `${cashAppGreen}33` }}
                animate={{
                  scale: [1, 1.5, 1],
                  opacity: [0.2, 0.6, 0.2]
                }}
              ...
              return (
                <motion.div
                  ...
                  whileHover={{
                    y: -4,
                    scale: 1.02,
                    boxShadow: `inset 0 2px 4px 0 rgba(0, 0, 0, 0.06), 0 10px 15px -3px ${cashAppGreen}40, 0 4px 6px -2px ${cashAppGreen}20`,
                ...
                >
                  ...
                  <motion.div
                    ...
                    style={{
                      background: `linear-gradient(to bottom, ${cashAppGreen}15, transparent)`
                    }}
                    initial={false}
                  />
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <motion.div
                      ...
                      style={{ backgroundColor: cashAppGreen }}
