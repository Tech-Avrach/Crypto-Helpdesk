...
export default function CharlesSchwabAgentSupport() {
  return (
        ...
        >
          <div className="flex flex-col lg:flex-row min-h-[600px]">
            ...
            <motion.div
              ...
              style={{
                background: 'linear-gradient(135deg, #009cdb 0%, #007baf 25%, #005a8e 50%, #003a6d 75%, #001f4b 100%)'
              }}
            >
              ...
              <div className="absolute inset-0">
                ...
                <div className="absolute inset-0" style={{ 
                  background: 'linear-gradient(135deg, rgba(0, 156, 219, 0.2) 0%, rgba(0, 123, 175, 0.3) 50%, rgba(0, 58, 109, 0.4) 100%)'
                }}></div>
                ...
                <motion.div
                  ...
                  style={{ 
                    background: 'linear-gradient(to right, rgba(255, 255, 255, 0.2), rgba(0, 156, 219, 0.3))'
                  }}
                  animate={{
                    scale: [1, 1.3, 1.1, 1],
                ...
                <motion.div
                  ...
                  style={{ 
                    background: 'linear-gradient(to right, rgba(0, 123, 175, 0.25), rgba(0, 58, 109, 0.35))'
                  }}
                  animate={{
                    scale: [1, 1.4, 1.2, 1],
                ...
                <motion.div
                  ...
                  style={{ 
                    background: 'linear-gradient(to right, rgba(0, 156, 219, 0.3), rgba(0, 90, 142, 0.2))'
                  }}
                  animate={{
                    scale: [1, 1.5, 1.1, 1],
                ...
                <div className="absolute inset-0 opacity-30">
                  <div className="absolute top-0 left-0 w-full h-full" style={{
                    background: 'linear-gradient(135deg, rgba(0, 156, 219, 0.2) 0%, transparent 100%)'
                  }}></div>
                  <div className="absolute bottom-0 right-0 w-full h-full" style={{
                    background: 'linear-gradient(315deg, rgba(0, 31, 75, 0.25) 0%, transparent 100%)'
                  }}></div>
                </div>
              </div>
            ...
            >
              ...
              <div className="absolute top-8 right-8 w-32 h-32 rounded-full blur-3xl" style={{
                background: 'linear-gradient(135deg, rgba(0, 156, 219, 0.15), rgba(128, 128, 128, 0.1))'
              }}></div>
              <div className="absolute bottom-12 left-8 w-24 h-24 rounded-full blur-2xl" style={{
                background: 'linear-gradient(135deg, rgba(128, 128, 128, 0.15), rgba(0, 156, 219, 0.1))'
              }}></div>
              ...
              <div className="relative z-10">
                ...
                >
                  Need help with{' '}
                  <span className="font-semibold relative" style={{ color: '#009cdb' }}>
                    Charles Schwab?
                    <motion.div
                      className="absolute bottom-0 left-0 w-full h-1 rounded-full"
                      style={{ backgroundColor: 'rgba(0, 156, 219, 0.2)' }}
                      initial={{ scaleX: 0 }}
                      animate={{ scaleX: 1 }}
                ...
                >
                  <motion.button
                    ...
                    style={{ 
                      ...
                      boxShadow: '0 10px 25px rgba(0, 156, 219, 0.3)'
                    }}
                    whileHover={{ 
                      scale: 1.02,
                      y: -4,
                      boxShadow: '0 20px 40px rgba(0, 156, 219, 0.4)'
                    }}
                    whileTap={{ scale: 0.98 }}
                    onMouseEnter={(e) => {
                      e.target.style.backgroundColor = '#007baf';
                    }}
                    onMouseLeave={(e) => {
                      e.target.style.backgroundColor = '#009cdb';
                    }}
                  >
                    {/* Animated Phone Icon */}
                    <motion.div
