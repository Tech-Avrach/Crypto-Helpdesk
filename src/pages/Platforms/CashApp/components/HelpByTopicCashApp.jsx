...
export default function HelpByTopicCashApp() {
  const topics = [
    {
      id: 1,
      title: "Getting Started",
      icon: Clock,
      description: "Create your account and explore Cash App features.",
      iconBg: "bg-[#00e011]",
    },
    {
      id: 2,
      title: "Payment and Account Issues",
    ...
    },
    {
      id: 6,
      title: "Privacy & Data",
      description: "Learn how Cash App keeps your data secure.",
      icon: Shield,
      iconBg: "bg-[#00e011]",
    },
    {
    ...
    },
    {
      ...
      description: "Understand market trends and Cash App analytics tools.",
      icon: BarChart3,
      iconBg: "bg-[#00e011]",
    }
  ];
  ...
  const TopicCard = ({ topic }) => {
    ...
    return (
      ...
      >
        ...
        <motion.div
          className="absolute inset-0 bg-gradient-to-br from-[#00e011]/30 via-transparent to-gray-50/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
          initial={false}
        />
        
        {/* Decorative Floating Glow */}
        <motion.div
          className="absolute -top-8 -right-8 w-16 h-16 bg-gradient-to-br from-[#00e011]/50 to-[#00e011]/30 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"
        ...
        <div className="relative z-10 mb-6">
          ...
          >
            <IconComponent 
              className={`w-8 h-8 ${topic.iconBg === 'bg-white' ? 'text-[#00e011]' : 'text-white'} group-hover:scale-110 transition-transform duration-300`} 
            />
          </motion.div>
        </div>
        ...
        {/* Border Highlight */}
        <motion.div
          className="absolute inset-0 border border-[#00e011]/50 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
          initial={false}
        />
      </motion.div>
    );
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-16 bg-white">
      ...
      >
        ...
        <div className="w-24 h-1 bg-gradient-to-r from-[#00e011] to-[#00b30e] rounded-full"></div>
      </motion.div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          className="absolute top-1/4 left-1/4 w-2 h-2 bg-[#00e011]/30 rounded-full"
          animate={{ y: [0, -20, 0], opacity: [0.3, 0.8, 0.3] }}
          transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute top-1/2 right-1/3 w-3 h-3 bg-[#00e011]/20 rounded-full"
