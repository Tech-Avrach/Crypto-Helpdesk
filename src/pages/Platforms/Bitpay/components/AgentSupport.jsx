        ...
        >
          <div className="flex flex-col lg:flex-row min-h-[600px]">
            ...
            <motion.div
              ...
              className="lg:w-2/5 relative bg-gradient-to-br from-[#293b92] via-[#293b92] to-slate-900 flex items-center justify-center p-8 lg:p-12 overflow-hidden"
            >
              {/* Enhanced Animated Background Pattern */}
              <div className="absolute inset-0">
                {/* Primary gradient overlay */}
                <div className="absolute inset-0 bg-gradient-to-br from-sky-400/20 via-[#293b92]/30 to-[#293b92]/40"></div>
                ...
                />
                <motion.div
                  className="absolute bottom-1/3 right-1/4 w-32 h-32 bg-gradient-to-r from-[#293b92]/25 to-[#293b92]/35 rounded-full blur-2xl"
                  animate={{
                    scale: [1, 1.4, 1.2, 1],
                ...
                />
                <motion.div
                  className="absolute top-1/2 right-1/6 w-24 h-24 bg-gradient-to-r from-[#293b92]/30 to-slate-300/20 rounded-full blur-xl"
                  animate={{
                    scale: [1, 1.5, 1.1, 1],
                ...
                <div className="absolute inset-0 opacity-30">
                  ...
                  <div className="absolute bottom-0 right-0 w-full h-full bg-gradient-to-tl from-[#293b92]/25 via-transparent to-transparent"></div>
                </div>
              </div>
            ...
            >
              ...
              <div className="absolute top-8 right-8 w-32 h-32 bg-gradient-to-br from-[#293b92]/50 to-gray-100/50 rounded-full blur-3xl"></div>
              <div className="absolute bottom-12 left-8 w-24 h-24 bg-gradient-to-br from-gray-100/60 to-[#293b92]/40 rounded-full blur-2xl"></div>
              ...
              <div className="relative z-10">
                ...
                >
                  Need to speak to an{' '}
                  <span className="font-semibold text-[#293b92] relative">
                    agent?
                    <motion.div
                      className="absolute bottom-0 left-0 w-full h-1 bg-[#293b92]/20 rounded-full"
                      initial={{ scaleX: 0 }}
                      animate={{ scaleX: 1 }}
                ...
                >
                  <motion.button
                    className="group relative inline-flex items-center gap-4 bg-[#293b92] hover:bg-[#293b92] text-white px-10 py-5 rounded-2xl font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-[#293b92]/50"
                    whileHover={{ 
                      scale: 1.02,
                      y: -4
                    }}
