    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 mb-6">
          ...
          >
            <IconComponent 
              className={`w-8 h-8 ${topic.iconBg === 'bg-white' ? 'text-blue-600' : 'text-white'} group-hover:scale-110 transition-transform duration-300`} 
            />
          </motion.div>
        </div>
        ...
        <motion.div
          className="absolute inset-0 border border-blue-200/50 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
          initial={false}
        />
      </motion.div>
    );
