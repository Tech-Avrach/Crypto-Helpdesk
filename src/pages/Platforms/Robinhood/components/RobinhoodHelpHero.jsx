...
export default function RobinhoodHelpHero() {
  const [searchQuery, setSearchQuery] = useState('');

  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-green-50 to-pink-50 flex items-center justify-center px-4">
        ...
        >
          <h1 className="text-gray-800 mb-4">
            ...
            <div className="text-4xl md:text-6xl font-medium mb-6">
              Having Issue in{' '}
              <span 
                className="font-black text-[#62f15b] px-4 py-2 rounded-lg inline-block transform hover:scale-105 transition-transform duration-200"
          ...
          <div className="relative max-w-2xl mx-auto">
            <div className="relative">
              ...
              <motion.div
                ...
                style={{
                  background: `linear-gradient(to right, rgba(251, 191, 36, 0.2), rgba(98, 241, 91, 0.2), rgba(236, 72, 153, 0.2))`
                }}
                animate={{
                  scale: [1, 1.02, 1],
                  opacity: [0.5, 0.8, 0.5]
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background: `linear-gradient(to right, #fbbf24, #62f15b, #ec4899)`
              }}
              animate={{
                x: ['-100%', '100%'],
              }}
